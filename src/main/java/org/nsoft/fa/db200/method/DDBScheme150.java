...
public class DDBScheme150 implements IDepreciationMethod {
    private static final BigDecimal BD_12 = BigDecimal.valueOf(12);
    private static final BigDecimal BD_15 = BigDecimal.valueOf(1.5);
    ...
    public BigDecimal caclulateDepreciation(DepreciationDTO dto) {
        ...
        BigDecimal annualRate = BD_15.divide(lifeYears, 8, RoundingMode.HALF_UP);
